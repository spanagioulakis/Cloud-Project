...
<div>
		...
		<div class="content">
        <div style="font-size:30px; color:#fff; margin-top:10px;background-color: #555;"><h2>Bad Request Page</h2>
		<p>  You dont have the permission for this page! Please click the link to redirect to home page <a href="welcome.php">Home Page</a>. </p></div>
		</div>
	</body>
</html>